"""Settings panel for Agorapulse Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__agorapulse_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=agorapulse_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_agorapulse"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Agorapulse Settings & Accounts", level=2),
